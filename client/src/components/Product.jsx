    ...
    return (
        <React.Fragment>
            <Link to={`/products/${product.ean}`}>
                <div title="product-container" className=" h-96 border border-gray-400 shadow-md rounded-md">
                    <div id="image-container">
                        <img id="product-img" src={product.image ?? "http://i.imgur.com/7Vbe8z9.jpg"} alt="product"
                             className="h-80 w-full object-fill rounded-md shadow-md brightness-50 hover:brightness-100 hover:transition 1s ease-in-out delay-100 "></img>
                    </div>
